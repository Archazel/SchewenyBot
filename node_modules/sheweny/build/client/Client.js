...
class ShewenyClient extends discord_js_1.Client {
    ...
    constructor(options, clientOptions) {
        ...
        this.handlers.commands = options.handlers?.commands
            ? new managers_1.CommandsManager(this, options.handlers.commands.directory, true, {
        ...
        this.handlers.selectMenus = options.handlers?.selectMenus
            ? new managers_1.SelectMenusManager(this, options.handlers.selectMenus.directory)
            : undefined;
